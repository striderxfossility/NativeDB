...
public class LocomotionPSMPrereq extends PlayerStateMachinePrereq {
  ...
  protected const func OnRegister(state: ref<PrereqState>, game: GameInstance, context: ref<IScriptable>) -> Bool {
    ...
    let castedState: ref<LocomotionPSMPrereqState> = state as LocomotionPSMPrereqState;
    ...
    castedState.m_listenerInt = bb.RegisterListenerInt(GetAllBlackboardDefs().PlayerStateMachine.Locomotion, castedState, n"OnStateUpdate");
    return false;
  }
