...
public class UpperBodyPSMPrereq extends PlayerStateMachinePrereq {
  ...
  protected const func OnRegister(state: ref<PrereqState>, game: GameInstance, context: ref<IScriptable>) -> Bool {
    ...
    let castedState: ref<UpperBodyPSMPrereqState> = state as UpperBodyPSMPrereqState;
    ...
    castedState.m_listenerInt = bb.RegisterListenerInt(GetAllBlackboardDefs().PlayerStateMachine.UpperBody, castedState, n"OnStateUpdate");
    return false;
  }
