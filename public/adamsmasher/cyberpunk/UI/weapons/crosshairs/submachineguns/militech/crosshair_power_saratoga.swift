...
public class Crosshair_Power_Saratoga extends gameuiCrosshairBaseGameController {
  ...
  protected cb func OnBulletSpreadChanged(spread: Vector2) -> Bool {
    ...
    inkWidgetRef.SetMargin(this.m_rightPart, new inkMargin(spread.X, -spread.Y, 0.00, 0.00));
