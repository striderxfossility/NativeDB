...
public class AIScanTargetTask extends AIbehaviortaskScript {
  ...
  protected final func CancelCommand(context: ScriptExecutionContext, typedCommand: ref<AIScanTargetCommand>) -> Void {
